# -*- encoding: utf-8 -*-
# stub: webmock 3.26.4 ruby lib

Gem::Specification.new do |s|
  s.name = "webmock".freeze
  s.version = "3.26.4".freeze

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "bug_tracker_uri" => "https://github.com/bblimke/webmock/issues", "changelog_uri" => "https://github.com/bblimke/webmock/blob/v3.26.4/CHANGELOG.md", "documentation_uri" => "https://www.rubydoc.info/gems/webmock/3.26.4", "source_code_uri" => "https://github.com/bblimke/webmock/tree/v3.26.4", "wiki_uri" => "https://github.com/bblimke/webmock/wiki" } if s.respond_to? :metadata=
